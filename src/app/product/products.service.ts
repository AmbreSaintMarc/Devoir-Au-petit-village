...
export class ProductsService {
  ...
  products: Product[] = [
    { name: 'Figurine Astérix', id: 1, photo: './figurine-asterix-embleme.jpg', price: 50, description : 'Figurine emblématique du personnage Astérix faite à la main.'},
    ...
    { name: 'Figurine Astérix et des albums', id: 3,  photo: './figurine-asterix-pile-d-albums.webp', price: 100, description : "Figurine du personnage Astérix avec une pile d'albums faite à la main." },
